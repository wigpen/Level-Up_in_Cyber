...
I tend to lean more towards defence than the offence of Red Teaming and Pen testing, however a well-rounded cyber will know a bit of everything and be able to do a bit of everything.
...
From the Beginning (cover any gaps, solid foundations)

-	Pre-Security core skills - https://tryhackme.com/path-action/introtocyber/join
-	Intro to Cyber Security - https://tryhackme.com/path-action/introtocyber/join
-	Cyber Defence - Where the really good stuff comes in - https://tryhackme.com/path-action/blueteam/join
-	Security Operation Level 1, not just for CSOC people, great info for everyone in Cyber - https://tryhackme.com/path-action/soclevel1/join

## FUNDAMENTALS (THESE CAN COUNT TOWARDS PATHS)
-	Windows - https://tryhackme.com/module/windows-fundamentals
-	Linux - https://tryhackme.com/module/linux-fundamentals
-	Networks - https://tryhackme.com/module/network-fundamentals
-	The Web - https://tryhackme.com/module/how-the-web-works

## SPECIFIC MODULES (OUTSIDE OF THE PATHS, BUT ALSO COUNT TOWARDS PATHS)
-	Intro to Defence - Digital Forensics and Security Operations - https://tryhackme.com/module/introduction-to-defensive-security
-	Cyber Defence Frameworks ... the gobidly gook gatekeepers use to deny you a job in Cyber - https://tryhackme.com/module/cyber-defence-frameworks
...
-	Digital Forensics and Incident Response - https://tryhackme.com/module/digital-forensics-and-incident-response
-	Identity and Access Management - https://tryhackme.com/module/introduction-to-iam
-	Attacking and Defending Core Services (read cloud services) - https://tryhackme.com/module/attacking-defending-core-services

## RECOMMENDED READING OR LISTENING IF YOU HAVE AMAZON AUDIBLE

| Book Title	| Author	| Synopsis	|
|-------------| --------| ----------------------------------------------------|
| The Cuckoos Egg	| Clifford Stoll	| Tracking a Spy Through the Maze of Computer Espionage is a his first-person account of the hunt for a computer hacker who broke into a computer at the Lawrence Berkeley National Laboratory (LBNL).	|
| At Large: The Strange Case of the World's Biggest Internet Invasion | David H. Freeman & Charles C. Mann	| Hailed as "a chilling portrait" by The Boston Globe and "a crafty thriller" by Newsweek, this astonishing story of an obsessive hacker promises to change the way you look at the Internet forever.	|
| Crime Dot Com: From Viruses to Vote Rigging, How Hacking Went Global | Geoff White	| Geoff White charts the astonishing development of hacking, from its birth among the ruins of the Eastern Bloc to its coming of age as the most pervasive threat to our connected world. He takes us inside the workings of real-life cybercrimes, revealing how the tactics of high-tech crooks are now being harnessed by nation states. From Ashley Madison to election rigging, Crime Dot Com is a thrilling account of hacking, past and present, and of what the future might hold. |
| The Lazarus Heist: From Hollywood to High Finance: Inside North Korea's Global Cyber War | Geoff White | Meet the Lazarus Group, a shadowy cabal of hackers accused of working on behalf of the North Korean state. It's claimed that they form one of the most dangerous criminal enterprises on the planet, having stolen more than $1bn in an international crime spree. Their targets allegedly include central banks, Hollywood film studios and even the British National Health Service. North Korea denies the allegations, saying the accusations are American attempts to tarnish its image.	|
